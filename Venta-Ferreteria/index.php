...
<head>
	...
	<title>Solitario Online</title>
</head>
<body>

<nav class="encabezado navbar navbar-expand-lg navbar-light">
...
<br>
<span>Monto Total: <b class="text-green"> <?=$divisa?> <?=$monto_total?></b></span>
...
<form method="post" action="?p=carrito">
  ...
  <footer class="footer">
        ...
        <p class="copy">&copy; Ferreteria "El Solitario" - Todos los derechos reservados.</p>
    </footer>
